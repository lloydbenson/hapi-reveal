...
exports.register = function (server, options, next) {
    ...
    var css = { handler: { directory: { listing: false, index: false, path: './node_modules/hapi-reveal/node_modules/reveal.js/css' } } };
    var lib = { handler: { directory: { listing: false, index: false, path: './node_modules/hapi-reveal/node_modules/reveal.js/lib' } } };
    var js = { handler: { directory: { listing: false, index: false, path: './node_modules/hapi-reveal/node_modules/reveal.js/js' } } };
    var plugin = { handler: { directory: { listing: false, index: false, path: './node_modules/hapi-reveal/node_modules/reveal.js/plugin' } } };
